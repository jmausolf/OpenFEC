...
gr_agnes_pid <- make_mean_graph_base_pid(df1_mean_pid_base, "agnes_pid_hca_all_base", plt_title1)
gr_agnes_ps <- make_mean_graph_base_ps(df1_mean_ps_base, "agnes_ps_hca_all_base", plt_title2)
...
gr_agnes_pid <- make_mean_graph_dem_pid(df1_mean_pid_dem, "agnes_pid_hca_all_dem", plt_title1)
gr_agnes_ps <- make_mean_graph_dem_ps(df1_mean_ps_dem, "agnes_ps_hca_all_dem", plt_title2)
...
gr_agnes_pid <- make_mean_graph_rep_pid(df1_mean_pid_rep, "agnes_pid_hca_all_rep", plt_title1)
gr_agnes_ps <- make_mean_graph_rep_ps(df1_mean_ps_rep, "agnes_ps_hca_all_rep", plt_title2)
...
gr_agnes_pid <- make_mean_graph_oth_pid(df1_mean_pid_oth, "agnes_pid_hca_all_oth", plt_title1)
gr_agnes_ps <- make_mean_graph_oth_ps(df1_mean_ps_oth, "agnes_ps_hca_all_oth", plt_title2)

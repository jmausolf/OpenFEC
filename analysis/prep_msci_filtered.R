...
#Small DF
df_post_cluster_m0_sm <- bind_rows(df_partisan_m0$dems, df_partisan_m0$rep,
                                   df_partisan_m0$oth) %>% 
  group_by(cid_master) %>% 
  mutate(dem = if_else(cluster_party == "DEM", 1, 0),
         rep = if_else(cluster_party == "REP", 1, 0),
...
#Small DF
df_post_cluster_m1_sm <- bind_rows(df_partisan_m1$dems, df_partisan_m1$rep,
                                   df_partisan_m1$oth) %>% 
  group_by(cid_master) %>% 
  mutate(dem = if_else(cluster_party == "DEM", 1, 0),
         rep = if_else(cluster_party == "REP", 1, 0),
...
# 
# #Small DF
# df_post_cluster_m2_sm <- bind_rows(df_partisan_m2$dems, df_partisan_m2$rep,
#                                    df_partisan_m2$oth) %>% 
#   group_by(cid_master) %>% 
#   mutate(dem = if_else(cluster_party == "DEM", 1, 0),
#          rep = if_else(cluster_party == "REP", 1, 0),
...
# 
# #Small DF
# df_post_cluster_m3_sm <- bind_rows(df_partisan_m3$dems, df_partisan_m3$rep,
#                                    df_partisan_m3$oth) %>% 
#   group_by(cid_master) %>% 
#   mutate(dem = if_else(cluster_party == "DEM", 1, 0),
#          rep = if_else(cluster_party == "REP", 1, 0),

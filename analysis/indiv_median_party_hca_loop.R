...
plt_title1 = "Republican vs. Democratic Firms - Median Partisanship (PID)"
plt_title2 = "Republican vs. Democratic Firms - Median Partisanship (PS)"

make_competing_partisans_graph(df_in_dem=df_median_pid_dem, 
                               df_in_rep=df_median_pid_rep, 
                               key="median_pid", plt_type = "dem_rep",
                               file_label = paste("hca", method, sep='_'), plt_title = plt_title1)

make_competing_partisans_graph(df_in_dem=df_median_ps_dem, 
                               df_in_rep=df_median_ps_rep, 
                               key="median_ps", plt_type = "dem_rep",
                               file_label = paste("hca", method, sep='_'), plt_title = plt_title2)
